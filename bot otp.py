...
admin = 5912395178
token = "8117170626:AAGWlwxjPq9Y6QbX2QVHnJMci9uo1f0Q2Hk"
...
def start(message):
    ...
    bot.send_photo(
        message.chat.id,
        photo=photo_url,
        caption="🤖 Bot Status: Active ✅ Join <a href=\"https://t.me/Trinity_CC\">Here</a> to Get Updates And Keys For The Bot. By <a href=\"t.me/RTC_CHEATS\" If You Want to Run a Bot In Your Group, Make Sure The Bot is The Admin 🎁",
...
def cmds_callback(call):
    ...
    keyboard.add(
        types.InlineKeyboardButton("𝐂𝐇𝐀𝐍𝐍𝐄𝐋", url="https://t.me/Trinity_CC"),
        types.InlineKeyboardButton("𝐃𝐄𝐕𝐄𝐋𝐎𝐏𝐄𝐑", url="https://t.me/RTC_OWNER")
    )
